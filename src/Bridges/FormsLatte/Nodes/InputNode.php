	...
	public function print(PrintContext $context): string
	{
		return $context->format(
			($this->name instanceof StringNode
				? 'echo end($this->global->formsStack)[%raw]->'
				: '$ʟ_input = is_object($ʟ_tmp = %raw) ? $ʟ_tmp : end($this->global->formsStack)[$ʟ_tmp]; echo $ʟ_input->')
			. ($this->part ? ('getControlPart(%raw)') : 'getControl()')
