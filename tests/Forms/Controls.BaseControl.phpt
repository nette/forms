...
test(function() { // validators
	...
	Assert::true( $input::validateMin($input, 122) );
	Assert::true( $input::validateMin($input, 123) );
	Assert::false( $input::validateMin($input, 124) );

	Assert::false( $input::validateMax($input, 122) );
	Assert::true( $input::validateMax($input, 123) );
	Assert::true( $input::validateMax($input, 124) );
});
