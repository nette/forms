...
test(function() { // translator
	...
	Assert::same('<label for="frm-text">LABEL</label>', (string) $input->getLabel());
	Assert::same('<label for="frm-text">ANOTHER LABEL</label>', (string) $input->getLabel('Another label'));
	Assert::same('<input type="text" name="text" placeholder="PLACE" id="frm-text" data-nette-empty-value="XXX" value="XXX">', (string) $input->getControl());
});
...
test(function() { // setEmptyValue
	...
	Assert::same('<input type="text" name="text" id="frm-text" data-nette-empty-value="empty">', (string) $input->getControl());
});
...
test(function() { // without setEmptyValue
	$form = new Form;
	$input = $form->addText('text');

	Assert::same('<input type="text" name="text" id="frm-text">', (string) $input->getControl());
});
